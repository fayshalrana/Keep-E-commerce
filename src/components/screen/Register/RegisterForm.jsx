...
const RegisterForm = ({handelShowForm, handleShowLogin}) => {
    return (
        <section className='w-full h-full fixed md:overflow-hidden top-0 left-0 bg-black/30 flex justify-center items-center z-[9999] p-8'>
            <div className=" md:w-[450px] 2xl:w-[500px] bg-white p-6 2xl:p-8 rounded-md relative mt-16 md:mt-7">
                ...
                <form action="" className='flex flex-col gap-2'>
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="password" className='pb-1 text-[14px] font-[500] leading-[22px] -tracking-[.2px] text-dark cursor-pointer'>Re-password*</label>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <label className='text-[16px] font-[500] leading-[24px] -tracking-[.3px] text-dark text-center' htmlFor="check">I accept <Link className='text-primary font-semibold' href="">terms</Link> & <Link className='text-primary font-semibold' href="">conditions</Link> </label>
                    </div>
                    <div className="mt-2">
                        <button type='submit' className='py-4 px-5 rounded-md w-full bg-primary text-white text-[18px] font-[500] leading-[24px] -tracking-[.3px]'>Create an account</button>
                    </div>
                    <div className="">
                        <p className='text-[16px] font-[500] leading-[24px] -tracking-[.3px] text-dark text-center'>Already have an account?
                            <button type='button' onClick={handleShowLogin} className='text-primary font-semibold'>Login</button>
                        </p>
                    </div>
                </form>
            </div>
